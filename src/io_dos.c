...
void setup_clk_aux(void) {
	...
	switch( setup_val) {
		...
		case 1:
			// setup RTC module. aux is not support
			printf("%s", setup2);
			printf("%s", setup3);
		...
		case 2:
		// setup timer0, and setup FT200XD module for aux.
			// setup timer0 and uart1
			printf("%s", setup0);
			printf("%s", setup4);
			setup_tomer0();
		...
		case 3:
		// setup RTC module, and setup FT200XD module for aux.
			printf("%s", setup2);
			printf("%s", setup4);
			clock_device = dev_DS1307;
			aux_device = dev_FT200XD;
